...
pytesseract.pytesseract.tesseract_cmd = "course-project-team-8\\Tesseract-OCR\\tesseract.exe"

# ### actual code
# filename = "C:\\Users\\USER\\cs222\\course-project-team-8\\Bounding Box\\input_image\\my_handwriting.png"
filename = r'C:\Users\USER\cs222\course-project-team-8\Bounding Box\input_image\HELLO_WORLD.png'
...
folder_dir = "course-project-team-8\Bounding Box\input_image"
for images in os.listdir(folder_dir):
    if (images.endswith(".png")):
        ...
        for b in boxes.splitlines():
            ...
            cropped_image_name = 'course-project-team-8/Bounding Box/output_image/cropped' + str(i) + ".png"
